...
export function initUI(emulator, sidebarRoot, contentRoot, cardSelectorEl) {
  ...
  contentRoot.innerHTML = `
    ...
    <img class="content-photo" src="https://images.unsplash.com/photo-1522623349500-de37a56ea2a5?q=80&w=2074&auto=format&fit=crop&ixlib=rb-4.1.0" alt="Film photography" draggable="false">
    <p class="content-body">
